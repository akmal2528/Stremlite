...
if os.path.exists(file_path):
    try:
        ...
        if 'kd_berita' in laptop_df.columns:
            laptop_df['desc_clean'] = laptop_df['kd_berita'].apply(clean_text)

            # Menghitung TF-IDF dan Cosine Similarity
            laptop_df.set_index('kd_berita', inplace=True)
            ...
            st.error("Kolom 'kd_berita' tidak ditemukan dalam dataset.")
